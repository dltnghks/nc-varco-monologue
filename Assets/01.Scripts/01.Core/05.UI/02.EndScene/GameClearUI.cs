...
public class GameClearUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("[GameClearUI] DialogueManager not found. Cannot play ending dialogue. Quitting immediately.");
            QuitGame();
            return;
        }
        ...
        System.Action onDialogueFinished = () => {
            Debug.Log("Game Clear dialogue finished. Quitting game.");
            QuitGame();
        };
