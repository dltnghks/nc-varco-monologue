...

{
    ...
    public void PlayDialogueSequence(List<WwiseAudioData> dialogueSequence)

    {
        ...
        dialogueCoroutine = StartCoroutine(DialogueSequenceCoroutine(dialogueSequence));

    }



    private IEnumerator DialogueSequenceCoroutine(List<WwiseAudioData> dialogueSequence)
